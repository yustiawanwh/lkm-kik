 ...
 */
export function panelRujukanSejawat(daftar, { judul = 'Rujukan: Nilai Rekan' } = {}) {
  ...
  return el('details', { class: 'rujukan-sejawat' }, [
    ...
    el('div', { style: 'margin-top:8px;' }, [
      ...
      !adaIsi
        ...
        : el('div', { style: 'display:flex;flex-direction:column;gap:8px;' }, daftar.map(d => {
            const r = ringkasSejawat(d.baris);
            if (r.jumlah === 0) {
            ...
            // Rentang ditampilkan supaya guru melihat bila penilaiannya
            // terbelah — rata-rata saja bisa menyembunyikan itu.
